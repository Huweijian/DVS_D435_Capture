...
struct EventArray_
{
  ...
  _width_type width;
   ...
   typedef std::vector< ::dvs_msgs::Event_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::dvs_msgs::Event_<ContainerAllocator> >::other >  _events_type;
  _events_type events;
